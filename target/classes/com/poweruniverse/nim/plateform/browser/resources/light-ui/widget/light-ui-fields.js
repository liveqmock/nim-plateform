...
//											fieldInputEl.val(fuJian.shangChuanWJM);
						...
						this.addListener(this.events.change,this._observer,function(eventSource,eventTarget,event,eventOriginal){
							if(contextThis.getValue()!=null){
								contextThis.handler.attr('src','resources/plateform/light-ui/images/file-uoload-remove.gif').attr( "title", "删除" );
							}else{
								contextThis.handler.attr('src','resources/plateform/light-ui/images/file-upload-icon.gif').attr( "title", "上传" );
							}
