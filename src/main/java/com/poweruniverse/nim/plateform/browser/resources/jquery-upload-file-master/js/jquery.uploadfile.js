            ...
            fileInput.change(function () {
                ...
                if(this.files) //support reading files
                {
                    ...
                    if(filenameStr.indexOf('\\') >=0){
                    	filenameStr = filenameStr.substr(filenameStr.lastIndexOf('\\')+1)
                    }
                    //
                    var flist = [];
                ...
                if(feature.fileapi && feature.formdata) //use HTML5 support and split file submission
                {
                    ...
                    ajaxFormSubmit(form, s, pd, fileArray, obj, flist[0]);
                }
				//王阳 2014-11-22 选择文件后给一个自动上传的机会
				s.afterSelect(flist);
            ...
            var options = {
                ...
                beforeSubmit: function (formData, $form, options) {
                    if(s.onSubmit.call(this, fileArray) != false) {
                        var dynData = s.dynamicFormData(form, s, pd, fileArray, obj, file);
                        if(dynData) {
